...
CREATE TABLE `estudio` (
  ...
  `ncbi_sample_classification` varchar(255) DEFAULT NULL,
  ...
  `id_bioma` bigint DEFAULT NULL,
  `id_material` bigint DEFAULT NULL,
  `descripcion_espanol` longtext,
  `descripcion_ingles` longtext,
  PRIMARY KEY (`id_estudio`),
  KEY `FK9ivma2s038155357ywfwnxdu0` (`id_usuario`),
  KEY `FKr393i5xsvqik1kpg0aw5t4jk` (`id_pais`),
  KEY `FKajoqsgnayponb5xodncvr1t5q` (`id_bioma`),
  KEY `FKmbfxwfm185eypuqxstfggvvtm` (`id_material`),
  CONSTRAINT `FK9ivma2s038155357ywfwnxdu0` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  CONSTRAINT `FKajoqsgnayponb5xodncvr1t5q` FOREIGN KEY (`id_bioma`) REFERENCES `bioma` (`id_bioma`),
  CONSTRAINT `FKmbfxwfm185eypuqxstfggvvtm` FOREIGN KEY (`id_material`) REFERENCES `material` (`id_material`),
...
CREATE TABLE `peso` (
  ...
  `id_usuario` bigint DEFAULT NULL,
  PRIMARY KEY (`id_peso`),
  KEY `FKne40p3omp37h5wemtjra8016c` (`id_usuario`),
  CONSTRAINT `FKne40p3omp37h5wemtjra8016c` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `talla` (
  ...
  KEY `FK4xcb9qes0vkn7b1k4hd0un8so` (`id_usuario`),
  CONSTRAINT `FK4xcb9qes0vkn7b1k4hd0un8so` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuario` (
  ...
  `documento_consentimiento` varchar(255) DEFAULT NULL,
  `fecha_consentimiento` datetime(6) DEFAULT NULL,
  `fecha_retiro` datetime(6) DEFAULT NULL,
  `aprobado` bit(1) DEFAULT NULL,
  `en_espera` bit(1) DEFAULT NULL,
...
CREATE TABLE `usuario_estudio` (
  ...
  `fecha_muestreo` datetime(6) DEFAULT NULL,
...
-- Dump completed on 2022-05-30 16:55:45
